...
const faqData = [
  {
    q: '初めてでも大丈夫ですか？',
    a: 'もちろんです。初めてのサロン利用のワンちゃんも大歓迎です。事前にカウンセリングを行いますので、不安なことや気になることはお気軽にお話しください。',
  },
  {
    q: '子犬・老犬でも利用できますか？',
    a: 'はい、パピーからシニア犬まで対応しております。それぞれの体調や年齢に合わせたペースで、やさしくトリミングいたします。',
  },
  {
    q: '予約はどうすればいいですか？',
  ...
  {
    q: '料金表にない犬種は対応していますか？',
    a: '犬種・毛質・サイズ・状態によって料金が異なる場合があります。まずはお気軽にお問い合わせください。',
  },
  {
    q: 'カットのスタイルは相談できますか？',
  ...
  },
  {
    ...
    a: '1頭ずつ丁寧に対応しておりますので、複数頭の場合は時間をずらしてご予約いただくか、ご相談の上調整させていただきます。',
  },
]
